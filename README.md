etreehtml is a small, copy & pasteable Python library to parse HTML code into [`xml.etree.ElementTree`](http://docs.python.org/library/xml.etree.elementtree.html).
